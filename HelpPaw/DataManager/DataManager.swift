        ...
        Shelter(
            ...
            animals: [
                ...
                Animal(
                    ...
                    name: "Лилу",
                    age: 1,
                    description: "Лилу удалось социализировать, отлично ладит с людьми, с другими животными, стерилизуем по возрасту за свой счет, будет небольших размеров, подойдет как для квартиры, также и для частного дома без цепи! Отдадим только в ответственные руки! Девочка нуждаются в социализации, если у вас есть такая возможность нам помочь, звоните, мы будем очень благодарны Вам!"
                )
            ]
        )
    ]
